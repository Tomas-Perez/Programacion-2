...
public class RectangleTest {
    ...
    public void getBase() throws Exception {
        assertEquals(segment1.howLong(), rectangle.getBase(), 0.1);
    }

    @Test
    public void getHeight() throws Exception {
        assertEquals(segment2.howLong(), rectangle.getHeight(), 0.1);
    }

    @Test
    public void getDiagonal() throws Exception {
        assertEquals(8.36, rectangle.getDiagonal(),0.01);
    }

    @Test
    public void getArea() throws Exception {
        assertEquals(33.5, rectangle.getArea(),0.1);
    }

    @Test
    public void getPerimeter() throws Exception {
        assertEquals(23.4, rectangle.getPerimeter(),0.1);
    }
}